...
{#if problem}
  ...
  <div
    class="flex items-center justify-center text-white banner drop-shadow-lg h-full"
  >
  ...
  >
    <TabItem open>
      ...
      <div class="m-4 mb-0 grid  grid-cols-4 gap-4 ">
        <Card padding='sm' class="flex justify-center items-center text-primary-700" size="2xl" color="primary">
          <i class="fas fa-info-circle text-7xl mb-2" />
          <h2 class="text-primary-900 text-2xl bold">Develop Problem Statement</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">Refine & develop your problem statement and gain feedback</p>
        </Card>
     
        <Card padding='sm' class="flex justify-center items-center text-primary-700 " size="2xl">
          <i class="fa fa-book-open  text-7xl mb-2" />
          <h2 class="text-primary-900 text-2xl bold">Gather Market Research</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">Checkout compertition & gather customer feedback</p>
        </Card>
        <Card padding='sm' class="flex justify-center items-center text-primary-700" size="2xl">
          <i class="fas fa-list-check text-7xl mb-2" />
          <h2 class="text-primary-900 text-2xl bold">Ideate & Plan</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">Outline and discuss the ideal solutions to this problem</p>
        </Card>
        <Card padding='sm' class="flex justify-center items-center text-primary-700 " size="2xl">
          <i class="fa-solid fa-people-group text-7xl mb-2 " />
          <h2 class="text-primary-900 text-2xl bold">Find Founders/Team</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">Find potential founders or team mates to build out the solution</p>
        </Card>
      </div> 
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5  mt-4">
        ...
        <div class="col-span-1 p-4 bg-gray-100  border mr-4 rounded-md mb-6 ">
          ...
          {#each sections as section}
            <p class="flex items-center gap-2 text-sm p-4 bg-white m-2 border {section.classes}">
              <i class="fas fa-link" />
              {section.text}
            </p>
          {/each}
