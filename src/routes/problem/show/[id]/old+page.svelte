...
{#if problem}
  ...
  >
    <h1 class="text-2xl lg:text-5xl drop-shadow-lg bg-primary-600 tx-white p-4">
      {problem.title}
    </h1>
  </div>

  <Tabs
    contentClass="border-0 bg-gray-50 h-full"
  ...
  >
    <TabItem open>
      ...
      <div class="m-4 mb-0 grid grid-cols-4 gap-4 hidden">
        <Card
          padding="sm"
        ...
        >
          ...
          <h2 class="text-primary-600 text-2xl bold">
        ...
        >
          ...
          <h2 class="text-primary-600 text-2xl bold">Gather Market Research</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">
        ...
        >
          ...
          <h2 class="text-primary-600 text-2xl bold">Ideate & Plan</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">
        ...
        >
          ...
          <h2 class="text-primary-600 text-2xl bold">Find Founders/Team</h2>
          <p class="text-gray-500 mt-5 text-md bold text-center">
      ...
      <div class="flex flex-row justify-center  items-center mt-4">
        <section class="col-span-3">
          <div class=" pr-4 pl-4 mb-6 max-w-[980px]">
            <Overview bind:problem editable={editable} />
          </div>
        </section>

        <div class="col-span-1 p-4 bg-gray-100 border mr-4 rounded-md mb-6 hidden">
          <h1 class="mb-4 text-xl text-primary-600">Sections</h1>
