...
{#if problem}
    ...
    <button
      class="text-left bg-white rounded-md border hover:border-gray-300 w-full md:flex flex-row"
      on:click={showProblem(problem)}
    >
 
      <div class="p-4 relative">
        <img
          class="w-full h-[200px] md:w-[200px] object-cover object-center border"
