<script lang="ts">
  ...
  $: myContribRequest =
    $auth?.loggedInUser &&
    problem?.contribution_requests?.find(
      (v: ContributionRequest) =>
        v.problem_id === problem.id && v.user_id === $auth.loggedInUser?.id
    );
</script>
    ...
    <div class="border bg-white z-30 p-4 md:hidden w-full absolute bottom-0">
        ...
        {:else}
          <div class="p-4 mb-4 bg-white border">
            <h1 class="text-center text-xl font-bold mb-2">
              <i class="fas fa-thumbs-up mr-2 text-green-500" /> Want To Get Involved?
            </h1>
            <Button
              class="w-full mr-2 "
              color="light"
      ...
      {:else}
        <div class=" bg-red-500">
          <div class="w-full text-white p-1 text-center text-xl font-bold">
            <i class="fas fa-thumbs-down mr-2" />
            You Hated It
          </div>
        </div>
...
<div class="md:flex max-w-[1200px] mx-auto">
  <div class="flex-1 md:space-y-4">
    ...
    <div class="border bg-white p-8 md:!mb-9">
  ...
  {#if !editable}
    <div class="shrink-0 md:w-[370px] md:p-4 relative h-full mb-[100px]">
      <div class=" md:w-[350px] overflow-auto h-full">
        <div class="hidden md:block">
          ...
          {#if myVote}
            ...
            {/if}
          {:else}
            <div class="border bg-white p-4 md:mb-4">
              <h1 class="text-center text-xl font-bold">
        ...
        <div class="mb-4 ">
          <h1 class="text-xl font-bold mb-2 hidden md:block">Latest Comments</h1>
...
<div class="mb-[100px] invisible">Empty space</div>
